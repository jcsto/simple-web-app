...
@section('content')
    ...
    <div class="container">
        <div class="text-center mt-5">
            <h1>Company {{ $company->name }} - Add New Employee</h1>
        </div>
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card mt-2 mx-auto p-4 bg-light">
                    <div class="card-body bg-light">
                        ...
                        <div class = "container">
                            <form role="form" method="post" action="{{ route('company.employee.store', ['id' => $company->id]) }}">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="full_name" type="text" name="full_name" class="form-control" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="position" type="text" name="position" class="form-control" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="yearly_salary">Salary (year) *</label>
                                                <input id="yearly_salary" type="text" name="yearly_salary" class="form-control" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
